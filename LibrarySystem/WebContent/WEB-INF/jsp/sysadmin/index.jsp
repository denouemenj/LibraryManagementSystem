...
<div class="header">
    ...
    <div class="dl-log">
    		Welcome：<span class="dl-log-user">${sysAdmin.uname }</span><a href="<%=request.getContextPath()%>/sysadmin/quit" class="dl-log-quit">[Exit]</a>
    </div>
</div>
<div class="content">
...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'Management',items:[
       		{id:'3',text:'Account Management',href:'<%=request.getContextPath()%>/sysadmin/showUser'},
       		{id:'12',text:'Book Management',href:'<%=request.getContextPath()%>/sysadmin/show'},
       		{id:'13',text:'Category Management',href:'<%=request.getContextPath()%>/sort/findAll'},
       	]}]}];
