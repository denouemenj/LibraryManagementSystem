...
<div class="header">
    ...
    <div class="dl-log">
    		Welcome：<span class="dl-log-user">${admin.uname }</span><a href="<%=request.getContextPath()%>/admin/quit" class="dl-log-quit">[Exit]</a>
    </div>
</div>
<div class="content">
...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:[{text:'My Books',items:[{id:'12',text:'Borrow Management',href:'<%=request.getContextPath()%>/admin/show'},{id:'3',text:'Return Management',href:'<%=request.getContextPath()%>/admin/backBooks'},{id:'4',text:'Reserve Management',href:'<%=request.getContextPath()%>/admin/showReserveBook'}]}]}];
