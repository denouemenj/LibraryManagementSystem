    	...
    	<tr>
            ...
            <td>
            	<c:if test="${allReserve.number>0}">
            		<a type="button" class="btn btn-success" href="<%=request.getContextPath()%>/admin/allowReserveBook?id=${allReserve.id}">Confirm Reservation</a>
            	</c:if>
            	<a type="button" class="btn btn-warning" href="<%=request.getContextPath()%>/admin/notAllowReserveBook?id=${allReserve.id}">Object Reservation</a>
            </td>
        </tr>	
    </c:forEach>
</table>
